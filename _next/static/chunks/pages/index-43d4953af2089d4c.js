...
class ZkappWorkerClient {
    ...
    Verificationproof(data, hash, proof) {
        const result = this._call("VerificationProof", {
            data: data,
            hash: hash,
            proof: proof
        });
    ...
    constructor(){
        this.worker = new Worker(__webpack_require__.tu(new URL(/* worker import */ __webpack_require__.p + __webpack_require__.u(620), __webpack_require__.b)));
        this.promises = {};
        this.nextId = 0;
...
function Home() {
    ...
    // -------------------------------------------------------
    // Send a transaction
    const verifyProof = async (data, hash, proof)=>{
        let a = await state.zkappWorkerClient.Verificationproof(data, hash, proof);
        console.log(a);
    };
                ...
                /*#__PURE__*/ (0,jsx_runtime.jsxs)("div", {
                    children: [
                        ...
                        /*#__PURE__*/ (0,jsx_runtime.jsx)("button", {
                            onClick: ()=>{
                                if (RealProof) {
                                    verifyProof(VerifiData, VerifiHash, RealProof);
                                } else {
